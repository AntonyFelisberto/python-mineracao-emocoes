...
stop_words_nltk.append("vou")
stop_words_nltk.append("tão")
...
frases_com_stemming_treinamento = aplicar_stemmer(base_treinamento)
palavras_treinamento = busca_palavras(frases_com_stemming_treinamento)
...
base_completa_treinamento = nltk.classify.apply_features(extrator_palavras,frases_com_stemming_treinamento)

frases_com_stemming_teste = aplicar_stemmer(base_teste)
palavras_teste = busca_palavras(frases_com_stemming_teste)
frequencia_teste = busca_frequencia(palavras_teste)
palavras_unicas_teste = busca_palavras_unicas(frequencia_teste)
base_completa_teste = nltk.classify.apply_features(extrator_palavras,frases_com_stemming_teste)

classificador_treinamento = nltk.NaiveBayesClassifier.train(base_completa_treinamento)
print(nltk.classify.accuracy(classificador_treinamento,base_completa_treinamento))
print(classificador_treinamento.labels())
print(classificador_treinamento.show_most_informative_features(5))

classificador_teste = nltk.NaiveBayesClassifier.train(base_completa_teste)
print(nltk.classify.accuracy(classificador_teste,base_completa_teste))
print(classificador_teste.labels())
print(classificador_teste.show_most_informative_features(5))

erros = []
for frase,classe in base_completa_teste:
    resultado = classificador_teste.classify(frase)
    if resultado != classe:
