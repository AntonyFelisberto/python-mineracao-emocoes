...
#caso diminua o numero de emocoes isso pode melhorar o desempeho da aplicacao pois ele tera menos processamentos para analisar e diferenciar
...
teste_stemming = []
stemmer = nltk.stem.RSLPStemmer()
for palavras_treinamento in testes.split():
