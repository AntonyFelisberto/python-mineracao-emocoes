...
nltk.download('stopwords') #stop words são palavras que não são necessarias para entendimento de algoritmo
...
#o steamming como ele separa os radicais como amo vira am, pode atrapalhar no entendimento do algoritmo, por isso as vezes é bom testar outros modos
...
testes = "estou com medo"
teste_stemming = []
stemmer = nltk.stem.RSLPStemmer()
for palavras in testes.split():
